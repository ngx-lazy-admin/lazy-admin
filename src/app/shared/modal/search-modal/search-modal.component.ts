...
@Component({
  ...
  template: `
    <div
      ...
      style="cursor: move;"
    >
      <div class="d-flex justify-content-between"> 11111 </div>
    </div>
    ...
    <div style="height: 500px;" class="position-relative">
      ...
      <footer
        class="d-flex f14 px-4 flex-nowrap position-absolute bottom-0 justify-content-between p-3 w-100  border-top"
      >
        <div class="result">180 result</div>
        <div class="arrows">
          <div id="omni-arrows"
            >Use arrow keys <span class="omni-shortcut bg-light mx-2">↑</span
            ><span class="omni-shortcut bg-light ">↓</span> to navigate</div
          >
        </div>
      </footer>
    </div>
...
export class SearchModal {
  ...
  searchValue = '';
  constructor(private cd: ChangeDetectorRef, private dispatch: DispatchService) {
